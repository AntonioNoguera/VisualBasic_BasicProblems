Public Class Form1
    ...
    Private Sub ButtonCalcular_Click(sender As Object, e As EventArgs) Handles ButtonCalcular.Click
        ...
        Select Case ComboBoxMenu.SelectedIndex
            Case 1 ' Suma
                resultado = num1 + num2
                LabelResultado.Text = "Resultado (Suma): " & resultado.ToString("F4")

            Case 2 ' Resta
                resultado = num1 - num2
                LabelResultado.Text = "Resultado (Resta): " & resultado.ToString("F4")

            Case 3 ' Multiplicación
                ' Validar el tercer número solo si es multiplicación
                If Double.TryParse(TextBoxNum3.Text, num3) Then
                    resultado = num1 * num2 * num3
                    LabelResultado.Text = "Resultado (Multiplicación): " & resultado.ToString("F4")
                Else
            ...
            Case 4 ' División
                ...
                Else
                    resultado = num1 / num2
                    LabelResultado.Text = "Resultado (División): " & resultado.ToString("F4")
                End If
